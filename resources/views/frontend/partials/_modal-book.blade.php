                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="date" name="pick_date"
                            ...
                            <div class="col-12">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="date" name="drop_date"
                            ...
                            <div class="form-group mt-3">
                                <a href="#" class="text-start text-white d-block mb-2">Upload Bukti Pembayaran DP,<span>
                                    </span>jika diperlukan: </a>
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="agree">
                                        Saya setuju dengan <a href="{{ route('blog') }}">syarat dan kondisi</a> yang
                                        berlaku
                                    </label>
