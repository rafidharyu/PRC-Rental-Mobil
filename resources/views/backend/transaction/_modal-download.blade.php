        ...
        <div class="modal-content">
            <div class="modal-header bg-gradient-dark">
                <h1 class="modal-title fs-5 text-white" id="staticBackdropLabel">
                    <i class="fas fa-file-excel"></i> Download Transactions
                </h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('panel.transaction.download') }}" method="post" id="downloadForm">
                    @csrf
                    <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="downloadForm" class="btn btn-submit">
